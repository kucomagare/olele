...
#
# cora_z7.tcl: Tcl script for re-creating project 'tcp_client'
#
# Generated by Vivado on Wed Apr 15 21:08:09 CEST 2026
...
#
# 1. This project restoration tcl script (cora_z7.tcl) that was generated.
#
...
set _xil_proj_name_ "tcp_client"
...
# Create project
create_project ${_xil_proj_name_} ./${_xil_proj_name_} -force -part xc7z010clg400-1
...
set_property -name "top" -value "CoraZ7_Eth_wrapper" -objects $obj
...
set file "[file normalize "$origin_dir/xdc/Cora-Z7-10-Master.xdc"]"
set file_imported [import_files -fileset constrs_1 [list $file]]
set file "xdc/Cora-Z7-10-Master.xdc"
...
set obj [get_filesets sim_1]
set_property -name "top" -value "axi_fir" -objects $obj
set_property -name "top_file" -value "$proj_dir/tcp_client.srcs/sources_1/new/axi_fir.v" -objects $obj
...
if { [get_property IS_LOCKED [ get_files -norecurse [list CoraZ7_Eth.bd]] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/tcp_client/tcp_client.gen/sources_1/bd/CoraZ7_Eth/hdl/CoraZ7_Eth_wrapper.v" ]
} else {
  set wrapper_path [make_wrapper -fileset sources_1 -files [ get_files -norecurse [list CoraZ7_Eth.bd]] -top]
...
set obj [get_runs synth_1]
set_property -name "part" -value "xc7z010clg400-1" -objects $obj
set_property -name "incremental_checkpoint" -value "$proj_dir/tcp_client.srcs/utils_1/imports/dcp/axi_fir.dcp" -objects $obj
set_property -name "auto_incremental_checkpoint" -value "1" -objects $obj
set_property -name "strategy" -value "Vivado Synthesis Defaults" -objects $obj

# Create 'synth_1_copy_1' run (if not found)
if {[string equal [get_runs -quiet synth_1_copy_1] ""]} {
    create_run -name synth_1_copy_1 -part xc7z010clg400-1 -flow {Vivado Synthesis 2023} -strategy "Vivado Synthesis Defaults" -report_strategy {No Reports} -constrset constrs_1
} else {
...
set_property -name "part" -value "xc7z010clg400-1" -objects $obj
set_property -name "auto_incremental_checkpoint" -value "1" -objects $obj
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/tcp_client.srcs/utils_1/imports/synth_1/synth_1_copy_1" -objects $obj
set_property -name "strategy" -value "Vivado Synthesis Defaults" -objects $obj
